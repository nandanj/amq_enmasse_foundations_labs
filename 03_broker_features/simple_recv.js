...
/* 0.17 on dev37 */
container.connect({port:args.port,host:"messaging-BROKEREDPROJECTNAME.apps.dev37.openshift.opentlc.com", username:'MYUSERNAME', password:'MYPASSWORD', transport:'tls',rejectUnauthorized:false}).open_receiver({source:args.node, snd_settle_mode:0});
